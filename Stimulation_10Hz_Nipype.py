...
output_dir  = '10Hz_Task_Based_OutputDir'
working_dir = '10Hz_Task_Based_WorkingDir'
...
templates = {
             ...
             'Stim_10Hz' : 'Data/{subject_id}/Stim_{subject_id}_??_10Hz_{session_id}.nii.gz',
...
preproc_task.connect([
              ...
              (selectfiles, Bet_mcf, [('Stim_10Hz','in_file')]),
