...
output_dir  = '20Hz_10s_Task_Based_OutputDir'
working_dir = '20Hz_10s_Task_Based_WorkingDir'
...
templates = {
 ...
 'Stim_20Hz_10s' : 'Data/{subject_id}/Stim_{subject_id}_??_20Hz_10s_{session_id}.nii.gz',
...
preproc_task.connect([
              ...
              (selectfiles, Bet_mcf, [('Stim_20Hz_10s','in_file')]),
